...
<div class="header">
    ...
    <c:if test="${login_admin != null && login_admin == 'success'}">
        ...
        <div class="fr top-link">
            <a href="javascript:void(0);" target="mainCont" title="DeathGhost"><i
                    class="adminIcon"></i><span>管理员：${admin.nickname}</span></a>
            ...
            <a href="${pgContext}/logoutServlet" target="_top" title="安全退出" style="background:rgb(60,60,60);"><i
