...
public class GetStickersServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        JSONObject jsonObject = pageBeanService.getStickersWithPageForAdmin(searchContent,order,thisPage,pageSize);
